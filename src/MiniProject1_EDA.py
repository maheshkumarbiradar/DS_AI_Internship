...
df = pd.read_csv("C:/DS_AI_Internship/data/customer_analytics.csv")
print(df.head())
print(df.info())
print(df.describe())
#Phase 2
...
plt.show()
"""The income distribution shows variation across customers, 
with most individuals concentrated in the mid-income range."""
...
plt.show()
"""The relationship between age and spending score appears weak, 
with spending distributed across different age groups."""
